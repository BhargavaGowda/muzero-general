...
class TicTacToe:
    def __init__(self):
        ...
        self.muSelfBoard = numpy.zeros((3, 3), dtype="int32")
        self.muEnemyBoard = numpy.zeros((3, 3), dtype="int32")
        self.oppSelfBoard = numpy.zeros((3, 3), dtype="int32")
        self.oppEnemyBoard = numpy.zeros((3, 3), dtype="int32")
        self.player = 1
    ...
    def step(self, action):
        ...
        if(self.board[row, col] == 0):
            self.board[row,col] = 1 if self.player == 1 else -1
            if(self.player == 1):
                self.muSelfBoard[row,col] = 1
            else:
                self.oppSelfBoard[row,col] = 1
            ...
            print("Conflict!")
            if(self.player == 1):
                self.muEnemyBoard[row,col] = 1
            else:
                self.oppEnemyBoard[row,col] = 1
            reward = 0
            done = self.have_winner() or len(self.legal_actions()) == 0
    ...
    def get_observation(self):
        board_player1 = self.muSelfBoard
        board_player2 = self.muEnemyBoard #numpy.where(self.board == -1, 1, 0)
    ...
    def legal_actions(self):
        ...
        for i in range(9):
            ...
            if (self.player == 1):
                if (self.muSelfBoard[row, col] == 0 and self.muEnemyBoard[row,col] == 0):
                    legal.append(i)
            else:
                if (self.oppSelfBoard[row, col] == 0 and self.oppEnemyBoard[row,col] == 0):
                    legal.append(i)
    ...
    def render(self):
        # print(self.muSelfBoard)
        # print(self.muEnemyBoard)
        print(self.oppSelfBoard)
        print(self.oppEnemyBoard)